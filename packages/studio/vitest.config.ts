...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@kienmatu/inkos-core/interactive-film/evaluator": resolve(__dirname, "../core/src/interactive-film/evaluator.ts"),
      "@kienmatu/inkos-core/interactive-film/graph-schema": resolve(__dirname, "../core/src/interactive-film/graph-schema.ts"),
      "@kienmatu/inkos-core/forecast/schema": resolve(__dirname, "../core/src/forecast/schema.ts"),
      "@kienmatu/inkos-core": resolve(__dirname, "../core/src/index.ts"),
    },
  },
  test: {
    include: ["src/**/*.test.ts"],
